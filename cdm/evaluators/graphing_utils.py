...
from cdm.evaluators.utils import calculate_avergae, count_unnecessary, count_treatment
        ...
        for line in f:
            if line.strip():
                ...
                if not fields:
                    ...
                    if "answers" in obj:
                        fields += ["Unnecessary Laboratory Tests", "Unnecessary Imaging", "Treatment Requested"]
...
def plot_graphs(run_type:str = "cdm"): 
    ...
    if run_type == "cdm": 
        model_paths = {'qwen3-4B': 'outputs/results_cdm.jsonl',}
    elif run_type == "full_info":
        model_paths = {'qwen3-4B': 'outputs/results_full_info.jsonl',}
